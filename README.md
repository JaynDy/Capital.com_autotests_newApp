...
// TEST_LICENSE=FCA TEST_BROWSER=chromium TEST_CTA=heroBanner,mostTradedMarketsBlock,tradingInstrument,readyToJoinBlock npx playwright test --list === 192 (without auth test)
...
// TEST_LICENSE=ASIC TEST_BROWSER=chromium TEST_CTA=heroBanner,mostTradedMarketsBlock,tradingInstrument,readyToJoinBlock npx playwright test --list === 243
...
TEST_LICENSE=SCB TEST_BROWSER=chromium TEST_CTA=heroBanner,mostTradedMarketsBlock,tradingInstrument,readyToJoinBlock npx playwright test --list === 2490 = 2450 and 39 - skipped (because MN,VI don't have marketAnalysis page and financeNews page only EN)
...
TEST_LICENSE=CySEC TEST_BROWSER=chromium TEST_CTA=heroBanner,mostTradedMarketsBlock,tradingInstrument,readyToJoinBlock npx playwright test --list === 2460 = 2421 and 39 - skipped (because MN,VI don't have marketAnalysis page and financeNews page only EN)
...
npm run test:markets -- --list // 6048 (2016)
