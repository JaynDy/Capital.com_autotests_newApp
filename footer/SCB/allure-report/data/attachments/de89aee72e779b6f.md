      ...
      - generic [ref=e192]:
        ...
        - generic [ref=e196]:
          - link [ref=e197] [cursor=pointer]:
            - /url: https://app.appsflyer.com/id1230088754?cp_device_id=c7dd45c7-dfa7-4092-9c8e-1c097a3c6f75&af_js_web=true&af_ss_ver=2_9_0&pid=organic_web&af_ss_ui=true
          - link [ref=e198] [cursor=pointer]:
            - /url: https://app.appsflyer.com/com.capital.trading?cp_device_id=c7dd45c7-dfa7-4092-9c8e-1c097a3c6f75&af_js_web=true&af_ss_ver=2_9_0&pid=organic_web&af_ss_ui=true
          - link [ref=e199] [cursor=pointer]:
            - /url: https://app.appsflyer.com/com.capital.trading.huawei-huawei?cp_device_id=c7dd45c7-dfa7-4092-9c8e-1c097a3c6f75&af_js_web=true&af_ss_ver=2_9_0&pid=organic_web&af_ss_ui=true
      - generic:
        - generic:
          - generic:
            - img "Mobile platform"
...
```ts
  ...
  38 |     if (this.pageData.urls) {
  39 |       // console.log("License:", this.license);
  40 |       // console.log("Urls:", this.pageData.urls);
  41 | 
  42 |       await this.page.goto(this.pageData?.urls?.[this.license], {
  43 |         waitUntil: "domcontentloaded",
  44 |       });
  45 |       await this.popups.dismissAll();
  46 |       return;
  47 |     }
  48 | 
  49 |     await this.page.goto(`${baseURL}/${this.pagePath}`, {
  50 |       waitUntil: "domcontentloaded",
  51 |     });
  52 |     await this.popups.dismissAll();
